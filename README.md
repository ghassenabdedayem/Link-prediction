...
The below figures show a simplified representaion of the implemented architecture. The activation functions and the fully connected layers (fc) after each sparse matrix multiplication (mm) are ommitted from the figure.<br>
